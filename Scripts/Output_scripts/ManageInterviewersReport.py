...
class ManageInterviewersOutputReport:
    ...
    def send_mail_report(self, collection):
        testdata_headers = ['Send Mail Interviewers', 'Confirm', 'Confirm(Send mail)', 'Criteria Notifier',
    ...
    def interviewer1_confirm_report(self, collection):
        testdata_headers = ['Nomination Tab', 'Arrow Down', 'Validate Job role', 'Confirm by Interviewers',
