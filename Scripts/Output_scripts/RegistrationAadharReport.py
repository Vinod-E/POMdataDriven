...
class AadharOutputReport:
    ...
    TestCases = 33
    use_case_name = 'AADHAR REGISTRATION FLOW'
    ...
    def __init__(self, version, server, start_date_time):
        ...
        self.__path = outputFile.OUTPUT_PATH['Aadhar_output']
        ...
        self.__history_path = outputFile.OUTPUT_PATH['Aadhar_output_history']
        self.__html_path = outputFile.OUTPUT_PATH['Aadhar_output_html']
