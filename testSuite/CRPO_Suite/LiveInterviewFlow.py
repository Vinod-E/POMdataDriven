...
from Scripts.LiveInterview.crpo_behalf_feedback import CrpoBehalfOfFeedback
...
class LiveInterviewFlow:
    ...
    try:
        ...
        behalf = CrpoBehalfOfFeedback(driver=driver, index=index, version=version)
    ...
    def event_live_schedule2(self):
        self.live_schedule.live_interview_schedule()
        self.LIVE_OUTPUT.live_schedule2_report(self.live_schedule.event_live_schedule_collection)
...
if Object.login_success:
    ...
    Object.behalf_of_interview()
    Object.event_live_schedule2()
