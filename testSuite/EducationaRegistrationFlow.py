...
class RegistrationEducation:
    ...
    def page_entry(self):
        ...
        self.Certi_output.entry_page_report(self.Education_page.entry_collection)

    def personal_details_entry(self):
        self.Education_page.personal_details_entry()
        self.Certi_output.personal_details_report(self.Education_page.pd_collection)
    ...
    def submit_register_data(self):
        ...
        self.Certi_output.submit_data_report(self.Education_page.submit_collection)
